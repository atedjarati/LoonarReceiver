...
// MOD_type: 3    Rsymb(sps): 200    Fdev(Hz): 400    RXBW(Hz): 3000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 145    API_TC: 29    fhst: 10000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 5 (BW =   3.09 kHz);  NB-filter 5 (BW = 3.09 kHz)
// 
// Modulation index: 4
*/
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x02, 0x1A, 0x60, 0x80
...
*/
#define RF_MODEM_RSSI_CONTROL_1 0x11, 0x20, 0x01, 0x4C, 0x04
