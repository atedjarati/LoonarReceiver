...
// MOD_type: 3    Rsymb(sps): 500    Fdev(Hz): 1000    RXBW(Hz): 5000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 145    API_TC: 29    fhst: 10000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 4 (BW =   5.16 kHz);  NB-filter 4 (BW = 5.16 kHz)
// 
// Modulation index: 4
*/
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x04, 0x16, 0x06, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x67, 0x67, 0x00, 0x1A, 0xFF, 0xFF, 0x00, 0x2A
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0x8A, 0x01, 0x80, 0xFF
